...
var parseCondition = function parseCondition(conditionObj) {
    ...
    var k = arguments[2];
    var op = arguments.length <= 3 || arguments[3] === undefined ? 'must' : arguments[3];
    var identifiers = {
        or: 'should',
        should: 'should',
        not: 'must_not',
...
var _class = function (_base) {
    ...
    _class.prototype.query = function query() {
        ...
        var searchType = arguments.length <= 0 || arguments[0] === undefined ? 'query_then_fetch' : arguments[0];
    ...
    _class.prototype.execute = function execute(data) {
        ...
        var optype = arguments.length <= 1 || arguments[1] === undefined ? 'create' : arguments[1];
