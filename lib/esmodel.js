                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        ...
                        case 2:
                            ...
                            return _context4.abrupt('return', this.adapter().find(parsedOptions));
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 2:
                            ...
                            return _context6.abrupt('return', this.adapter().count(parsedOptions));
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            ...
                            return _context7.abrupt('return', this.error('need sum field'));
                        ...
                        case 8:
                            res = _context7.sent;
                            return _context7.abrupt('return', res.aggregations.sum.value);
                ...
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            ...
                            return _context8.abrupt('return', this.error('need avg field'));
                        ...
                        case 8:
                            res = _context8.sent;
                            return _context8.abrupt('return', res.aggregations.avg.value);
                ...
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        case 0:
                            ...
                            return _context9.abrupt('return', this.error('need min field'));
                        ...
                        case 8:
                            res = _context9.sent;
                            return _context9.abrupt('return', res.aggregations.min.value);
                ...
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        case 0:
                            ...
                            return _context10.abrupt('return', this.error('need max field'));
                        ...
                        case 8:
                            res = _context10.sent;
                            return _context10.abrupt('return', res.aggregations.max.value);
